...
<body>
	<div class="menu">
		<div class="menus">
			...
			<form class="yang1" action="/student_shujia2/DeleteGradesServlet" method="post">
				根据学号删除&nbsp;&nbsp;&nbsp;<input type="text" name="number"
					style="height: 25px; width: 200px;"> <input type="submit"
					value="确定" style="height: 20px; width: 30px">&nbsp;&nbsp;&nbsp;
			</form>
			<form class="yang2" action="/student_shujia2/NameQueryGradesServlet">
				名字查找&nbsp;&nbsp;&nbsp;<input type="text" name="name"
					style="height: 25px; width: 200px;"> <input type="submit"
					value="确定" style="height: 20px; width: 30px">
			</form>
		</div>
